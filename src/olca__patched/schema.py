...
class AllocationType(Enum):
    ...
    PHYSICAL = 'PHYSICAL_ALLOCATION'
    ECONOMIC = 'ECONOMIC_ALLOCATION'
    CAUSAL = 'CAUSAL_ALLOCATION'
    USE_DEFAULT = 'USE_DEFAULT_ALLOCATION'
    NONE = 'NO_ALLOCATION'
    
    @classmethod
    def normalize(cls, value):
        """
        The AllocationType Enum changed when going to OpenLCA 2.0.
        This method may ease the transition.
        """
        if value == 'PHYSICAL':
        ...
        elif value == 'USE_DEFAULT':
            return 'USE_DEFAULT_ALLOCATION'
        elif value == 'NONE':
...
class AllocationFactor(Entity):
    ...
    def read_json(self, json: dict):
        ...
        if val is not None:
            val = AllocationType.normalize(val)
...
class CalculationSetup(Entity):
    ...
    def to_json(self) -> dict:
        ...
        if self.allocation_method is not None:
            json['allocation'] = self.allocation_method.value
...
class Exchange(Entity):
    ...
    def to_json(self) -> dict:
        ...
        if self.input is not None:
            json['isInput'] = self.input
        if self.quantitative_reference is not None:
            json['isQuantitativeReference'] = self.quantitative_reference
...
class DQSystem(CategorizedEntity):
    ...
    the data quality scores are defined as a linear order $1 ots n$. In
